...
RSpec.describe TestNetworkGraph, type: :model do
  describe "making nodes and edges" do
    ...
    it "makes nodes and edges" do
      nodes = [
        { id: 1, created_at: @test_network_graph.created_at, label: 'BUILDING: building1', cable_run_id: 22, network_graph_id: 55, node_level: 0, node_type: 'building', node_value: 'building1', parent_id: nil, updated_at: @test_network_graph.updated_at },
        { id: 2, created_at: @test_network_graph.created_at, label: 'OLT: olt1', cable_run_id: 22, network_graph_id: 55, node_level: 1, node_type: 'olt', node_value: 'olt1', parent_id: 1, updated_at: @test_network_graph.updated_at },
        { id: 3, created_at: @test_network_graph.created_at, label: 'BUILDING: building2', cable_run_id: 22, network_graph_id: 55, node_level: 0, node_type: 'building', node_value: 'building2', parent_id: nil, updated_at: @test_network_graph.updated_at }
      ]
      ...
      assert_equal [0, 1, 0], data.collect { |r| r[:node_level] }
    ...
    it "port nodes are on the same level as the ont_sn" do
      ...
      nodes = [
        { id: 1, label: 'ONT_SN: N/A', cable_run_id: 22, network_graph_id: 55, node_level: 0, node_type: 'ont_sn', node_value: 'N/A', parent_id: nil, created_at: @test_network_graph.created_at, updated_at: @test_network_graph.updated_at },
        { id: 2, label: 'ONT_GE_1_MAC: N/A', cable_run_id: 22, network_graph_id: 55, node_level: 1, node_type: 'ont_ge_1_mac', node_value: 'N/A', parent_id: 1, created_at: @test_network_graph.created_at, updated_at: @test_network_graph.updated_at },
        { id: 3, label: 'ONT_GE_2_MAC: N/A', cable_run_id: 22, network_graph_id: 55, node_level: 1, node_type: 'ont_ge_2_mac', node_value: 'N/A', parent_id: 1, created_at: @test_network_graph.created_at, updated_at: @test_network_graph.updated_at }
      ]
      ...
      assert_equal [0, 1, 1], data.collect { |r| r[:node_level] }
